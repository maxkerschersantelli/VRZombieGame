...
// GvrAudioSource[]
struct GvrAudioSourceU5BU5D_t3340679355  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) GvrAudioSource_t2139450958 * m_Items[1];

public:
	inline GvrAudioSource_t2139450958 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline GvrAudioSource_t2139450958 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, GvrAudioSource_t2139450958 * value)
	{
		m_Items[index] = value;
		Il2CppCodeGenWriteBarrier(m_Items + index, value);
	}
